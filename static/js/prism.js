/* PrismJS 1.23.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+bash+batch+clojure+diff+git+groovy+ignore+java+javadoc+javadoclike+javastacktrace+js-extras+json+json5+kotlin+markdown+properties+scala+toml+yaml&plugins=line-numbers+highlight-keywords+normalize-whitespace */
